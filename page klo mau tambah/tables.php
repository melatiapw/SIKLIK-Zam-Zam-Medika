                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
									<?php
									$sql= "SELECT * FROM pasien ORDER BY id ASC"; // Menampung perintah SQL ke variabel ‘sql’
									...
									echo "<td class="center">$data[id_pasien]</td>"; // Menampilkan data judul
									echo "<td class="center">$data[nama_pasien]</td>"; // Menampilkan data pengarang
									echo "</tr>";
									}
									}
									?> 
