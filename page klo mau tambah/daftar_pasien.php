                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                          <div>
                                            <a data-toggle="modal" data-target="#EditDesignerDataModal" href=""
                                              ...
                                              <div class="modal-content">
                                               ...
                                               $id = @$_GET['id'];
                                                if(@$_POST['edit']){
                                                  ...
                                                  $alamat = @$_POST ['alamat'];
                                                  $nomor = @$_POST ['nomor'];
                                                  mysqli_query($connect, "UPDATE pasien SET nama_pasien='$pasien', golongan_darah='$goldar', umur='$umur' jenis_kelamin='$jk', tensi_darah='$tensi', alamat='$alamat', no_telepon='$nomor' WHERE id_pasien='$id'") or die ($connect->error);
                                                    //header("location:?page=daftar_pasien");
                                                }
                                                ?>
